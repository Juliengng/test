    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
           ...
           <li><a href="ambassador_advertisement.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Advertisements</span></a></li>
                        <li class="active"><a href="amb_dashboard_profile"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Profile Page</span></a></li>
	   ...
	   <form method="post"  action="../controller/modifyinfo.php"> 
				...
				<button class="btn btn-danger" type="submit" name="modifieramba" value="modifieramba">Validate</button>
			</div>
				<div class="col-sm-6" >
