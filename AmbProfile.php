...
if($_SESSION['username'] != null)
{
		...
		$sql = "SELECT * FROM `amb_personal_info` WHERE `amb_personal_info`.`AmbUsrName` = '$id'";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Ambassador Profile </h1>
          <ol class="breadcrumb">
            <li><a href="index.php">Home</a> </li>
            <li class="active">Ambassador profile</li>
          </ol>
        </div>
      </div>
      <!-- /.row -->
      <div class="row"><b> </b>
        <section style="margin-left: 19px;" id="personalinfo"><br>
          ...
          <p class="lead">Mailing address:  <?php echo $row[6] ?> </p>
          <p class="lead">Contact number: <?php echo $row[7] ?> </p>
          <p class="lead">Occupation: <?php echo $row[9] ?> </p>
          <p class="lead">Skype account:<?php echo $row[8] ?> </p>
          <p class="lead">Personal description:<?php echo $row[10] ?> </p>
          <p class="lead"><br>
          </p>
          <section id="uinfo">
            <p> <a class="btn btn-primary" href="ambassador_home.php">Back</a> </p>
            <hr>
            <footer>
              <div class="row">
                <div class="col-lg-12">
