                ...
                <form method="post" action="../controller/add_internship.php" >
                    <h2><b> My company: <?php echo $firmname ?></b></h2><br>
                    	 <?php 
						    ...
						    echo'<div class="containera"><h4 style="color:red">';
						    echo $_GET["msg"];
						    echo'</h4></div>';
							}
							 if(isset($_GET["msg2"])) 
                        ...
                        <div class="containera add">
                            ...
                            <input type="text" name="name" class="cusform" required>
                            
                            <div class="line">
                                <h4><b>Supervisor name*</b></h4>
                                <input type="text" name="sup" class="cusform" required>
                            </div>
                            <div class="line">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h4><b>Number of intern*</b></h4>
                                        <input type="number" name="number" class="cusform grand" min="1" required>
                                    </div>
                                    <div class="col-md-4 ">
                                        <h4><b>Application Deadline</b>     <i class="glyphicon glyphicon-paste"></i></h4>
                                        <input type="date" placeholder="Application Deadline" name="deadline" class="cusform grand" required>
                                    </div>
                                </div>                               
                            </div>
                            <div class="line">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="date"  name="startdate" class="cusform grand" required>
                                    </div>
                                    <div class="col-md-4 ">
                                        <h4><b>Minimum duration</b>      <i class="glyphicon glyphicon-hourglass"></i></h4>
                                        <div class="input-group">
                                          <input type="number" name="duration" class="cusform tgrand" min="1">
                            ...
                            <div class="line">
                                        <h4><b>Allowance*</b></h4>
                                        <input type="text"  name="price" class="cusform " required>
                        ...
                        <div class="containera add">
                            <div class="line">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h4><b>City*</b></h4>
                                        <input type="text"  name="city" class="cusform grand " required>
                                    </div>
                                    <div class="col-md-4">
                                        <h4><b>Country*</b></h4>
                                        <input type="text"  name="country" class="cusform grand " required>
                                    </div>
                                    <div class="col-md-3">
                                        <h4><b>Postal zip*</b></h4>
                                        <input type="textarea"  class="cusform grand" required>
                                    </div>
                                </div>
                            </div>
                            <div class="line">
                                <h4><b>Mailing address*</b></h4>
                                <textarea type="text"  class="cusform grand" required></textarea>
                            </div>
                        ...
                        <div class="containera add">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select id="jobcategory1" name="jobcategory1" title="Internship" class="cusform selectpicker"><br>
                                                    ...
                                                    <option data-hidden="true">Summer job</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <h4><b>Choose a sub-category*</b></h4>
                                        <select id="jobcategory" name="jobcategory" title="Internship" class="cusform selectpicker" required><br>
                            ...
                            <div class="line">
                                ...
                                <textarea  name="description" class="cusform" required></textarea>
                            </div>
                            <div class="line">
                                <h4><b>Living Cost per month (food/rent/transport)</b></h4>
                                <input type="number"  name="living" class="cusform" required>
                            </div>   
                        </div>
                        ...
                        <div class="containera add">
                            <div class="line">
                                <h4><b>Language*</b></h4>
                                    <select name="language" title="Language" class="cusform selectpicker" required></h4>
                                    ...
                                    <select name="languagelevel" title="LanguageLevel" class="cusform petit selectpicker" required><br>
               ...
               <div class="form-group">
                  <div class="input-group col-sm-8">
                    <div class="container">
                      <div class="Receptionist">
                          <b>Practical skills for "Receptionist"</b><span style="color:red">  Please, select 5 items maximum</span><br><br>
                      </div>
                      <div class="Chef">
                          <b>Practical skills for "Chef"</b><span style="color:red">  Please, select 5 items maximum</span><br><br>
                      </div>
                       
                    <div class="Waiter">
                          <b>Practical skills for "Waiter"</b><span style="color:red">  Please, select 5 items maximum</span><br><br>
                      </div>
                      <div class="Bartender">
                         <b>Practical skills for "Bartender"</b><span style="color:red">  Please, select 5 items maximum</span><br><br>
                      </div>
                 ...
                 <div class="form-group">
                  <div class="input-group col-sm-8"><br>
                        <div class="container">
                            <div class="Receptionist">
	                        <b>Personal skills for "Receptionist"</b><span style="color:red">  Please, select 5 items maximum</span><br><br>
	                    	</div>
		                    <div class="Chef">
		                        <b>Personal skills for "Chef"</b><span style="color:red">  Please, select 5 items maximum</span><br><br>
		                    </div>
		                    <div class="Waiter">
		                        <b>Personal skills for "Waiter"</b><span style="color:red">  Please, select 5 items maximum</span><br><br>
		                    </div>
		                    <div class="Bartender">
		                       <b>Personal skills for "Bartender"</b><span style="color:red">  Please, select 5 items maximum</span><br><br>
		                </div>
                    </div>
