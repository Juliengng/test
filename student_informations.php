...
require('../controller/student_informations_isset.php'); 
require('../controller/student_info.php');
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Informations about <b><?php echo $name; ?> <?php echo $surname; ?></b></li>
                    </ol>
                <div class="row">
	               <div class="col-xs-12 col-md-6">
                   
                    <?php include("../Controller/firm_student_info.php");?>
					
					<?php include("../Controller/firm_student_education.php");?>

                    </div>
                    <div class="col-xs-12 col-md-4">
                       
                                    <?php include("../Controller/firm_studentphoto.php");?>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                            <table class="customtable">
                                ...
                                <?php include("../Controller/firm_student_skills.php");?>
                            </table>   
                         ...
                         <div class="col-xs-12 col-md-6">
                            <table class="customtable">
                                ...
                                <?php include("../Controller/firm_student_persoskills.php");?>
                             </table>
