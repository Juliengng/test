 ...
 <body class="home">
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
				...
				<div class="col-sm-4">
									<img class="img-circle"  src="assets/profilepics/<?php echo $profilepic; ?>" width="200" height="200" class="mb-7 hero-image"></p>
				<p style="font-size:1.5em">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $name; ?></p>
				</div>
  ...
  <tr>
    ...
    <th><span></span></th>
     ...
     <?php include("../controller/student_loggedin_personalinfo.php"); ?>
