    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a href="ambassador_dashboard.php"><img style="border: 0;" src="assets/img/logoamba.jpg" alt="merkery_logo" class="hidden-xs hidden-sm">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="ambassador_postintern.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Add Internship</span></a></li>
						 <li><a href="ambassador_advertisement.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Advertisement</span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    <h1>Hello, <?php echo $name;?>! Thanks for being an intern advisor.</h1>
<table class="responstable">
  
  <tr>
    <th>Post</th>
    <th><span>Candidates</span></th>
    <th>Demanded Fees</th>
    <th>My Fees</th>

  </tr>
     <?php include("../controller/amba_internship_list.php"); ?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header login-header">
                    ...
                    <h4 class="modal-title">Add Internship</h4>
                </div>
                <div class="modal-body">
                            <input type="text" placeholder="Internship Position" name="position">
							<input type="text" placeholder="Localisation(City and Country)" name="localisation">
                            ...
                            <input type="text" placeholder="Duration(Weeks or Months)" name="duration">
                            <input type="date" placeholder="Author" name="passsword">
                            <textarea placeholder="Description"></textarea>
                    </div>
                <div class="modal-footer">
                    <button type="button" class="cancel" data-dismiss="modal">Close</button>
                    <button type="button" class="add-project" data-dismiss="modal">Add Internship</button>
                </div>
            </div>
