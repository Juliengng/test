...
<html lang="en">
  <head>
   ...
   <body class="home" style="z-index: 10">
                                ...
                                <tr style="color:#504e63">
                                    ...
                                    <td style="width:8%"><a href="firm_calendar_internship.php?ID=<?php echo "$internship[InternshipID]"; ?>">
                                        ...
                                        foreach ($applicants as $applicant)
                                        {
                                            ...
                                            $usrname=$applicant['StuUsrName'];
                                            require('../Controller/student_info.php');
                                            if($x<4){
                                            ?>
                                            <p><?php echo "$x"; ?>) <?php echo $name;echo' ';echo $surname; ?></i></p>
                                            <div class="progress">
                                            <div class="progress-bar progress-bar-custom progress-bar-striped" role="progressbar" aria-valuenow="<?php echo "$applicant[match]"; ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo "$applicant[match]"; ?>%">
                                              <?php echo "$applicant[match]"; ?>%
                                            </div> 
                                            </div>
                                        <?php } $x++; 
                                        } ?>       
