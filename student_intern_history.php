...
<html lang="en">
 ...
 <body class="home">
            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
						...
						<li class="active"><a href="#"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Internship History</span></a></li>
  ...
  <tr>
    <td><b>Boardingates</b><br>Number : 1</td>
    <td><b>Computer Scientist</b></td>
    <td><i class="fa fa-check-square" aria-hidden="true"></i> Completed on <b>15/04/2015</b></td>


  </tr>
  
  <tr>
    <td><b>Boardingates</b><br>Number : 2</td>
    <td><b>Computer Scientist</b></td>
    <td><i class="fa fa-check-square" aria-hidden="true"></i> Completed on <b>15/02/2016</b></td>
  </tr>
  
  <tr>
       <td><b>Alliance Francaise</b><br>Number : 3</td>
    <td><b>Teacher</b></td>
    <td><i class="fa fa-hourglass" aria-hidden="true"></i> Will complete on <b>14/04/2017</b></td>
