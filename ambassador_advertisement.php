                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="ambassador_postintern.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Add Internship</span></a></li>
						 <li class="active"><a href="#"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Advertisements</span></a></li>
...
<table class="responstable">
  ...
  <tr>
    ...
    <th><span>Student's Name</span></th>
	 <th><span>Student's Email</span></th>
    <th>Language</th>
    <th>Duration</th>
	 <th>Location</th>

  </tr>
     <?php include("../controller/amba_advertisement_list.php"); ?>
