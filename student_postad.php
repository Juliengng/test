    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
					...
					<li ><a href="student_dashboard.php"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Search Internship</span></a></li>
                        ...
                        <li class="active"><a href="#"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Post Advertisement</span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
				...
				<div class="row">
				<div class="col-sm-5"><h1 style="float:left">Post an advertisement</h1>
			</div>
					</div>
                  <h1>Fill in the details below to add an advertisement</h1>
               <form method="post" action="../Controller/add_advertisement.php" >
                        <input type="text" placeholder="Position Title" name="position" class="add_intern"> <br><br>
						<input type="text" placeholder="Language" name="language" class="add_intern"><br><br>
                        <input type="text" placeholder="Duration" name="duration" class="add_intern"><br><br>
						<input type="text" placeholder="Location" name="location" class="add_intern"><br><br>
                
                <button type="submit" class="button-mdn dark" formmethod="post" name="submit" value="submit" style="width:40%;margin-left:30%;"><i class="fa fa-plus" aria-hidden="true"> </i> Add advertisement</button>
                </form>
                </div>
            </div>
